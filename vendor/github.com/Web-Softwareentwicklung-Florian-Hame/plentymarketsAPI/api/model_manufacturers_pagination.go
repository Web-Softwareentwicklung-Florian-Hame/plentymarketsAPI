...
// ManufacturersPagination pagination response containing categories
type ManufacturersPagination struct {
	...
	Entries *[]Manufacturer `json:"entries,omitempty"`
}
...
// SetEntries gets a reference to the given []Manufacturer and assigns it to the Entries field.
func (o *ManufacturersPagination) SetEntries(v []Manufacturer) {
	o.Entries = &v
}

func (o ManufacturersPagination) MarshalJSON() ([]byte, error) {
...
type NullableManufacturersPagination struct {
	value *ManufacturersPagination
	isSet bool
}

func (v NullableManufacturersPagination) Get() *ManufacturersPagination {
	return v.value
}

func (v *NullableManufacturersPagination) Set(val *ManufacturersPagination) {
	v.value = val
	v.isSet = true
}

func (v NullableManufacturersPagination) IsSet() bool {
	return v.isSet
}

func (v *NullableManufacturersPagination) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableManufacturersPagination(val *ManufacturersPagination) *NullableManufacturersPagination {
	return &NullableManufacturersPagination{value: val, isSet: true}
}

func (v NullableManufacturersPagination) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableManufacturersPagination) UnmarshalJSON(src []byte) error {
	v.isSet = true
